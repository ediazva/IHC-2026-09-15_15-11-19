...
{
	((  void (*) (Enumerator_t02497793DC9D66E32AE51A629E8335F754C05FA5*, const RuntimeMethod*))Enumerator_Dispose_m3D89F01AE65EC60062FFB578C0E771C098EF2CB7_fshared)(__this, method);
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void OVRSkeletonMapping__ctor_mAD0EFFB4E51B507EC352ED9DB0FFF1C92D3E09A7 (OVRSkeletonMapping_tC39AC901BBAA2614D5C1006273A949399BF370BE* __this, const RuntimeMethod* method) 
{
	...
	CHECKED_LOCAL(OVRSkeletonMapping_tC39AC901BBAA2614D5C1006273A949399BF370BE_StaticInit);
	//<source_info:<no-source>:1>
	{
		CHECKED_LOCAL_INIT(OVRSkeletonMapping_tC39AC901BBAA2614D5C1006273A949399BF370BE_StaticInit,(OVRSkeletonMapping_tC39AC901BBAA2614D5C1006273A949399BF370BE_il2cpp_TypeInfo_var),il2cpp_codegen_runtime_class_init_inline);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR RuntimeObject* OVRSkeletonMapping_GetJointMapping_mC46382B1A968F2553D2277D242247DB818318809 (int32_t ___0_jointSet, const RuntimeMethod* method) 
{
	...
	memset((&V_3), 0, sizeof(V_3));
	{
		...
		L_2 = Dictionary_2_GetEnumerator_mDDC9ABDE22EE7CA33D63430594657C6828B499A9(L_1, NULL);
		V_1 = L_2;
	}
	{
...
FINALLY_003a:
			{
				Enumerator_Dispose_m235FFE68D8E3B1ECC1BA0CCCCB53DA2A013133FB((&V_1), NULL);
				return;
			}
		});
		try
...
IL_0013_1:
			{
				...
				L_3 = Enumerator_get_Current_mD26596B306CFC7394F84A3A7A59E9F1D37B47DBE_inline((&V_1), NULL);
				V_2 = L_3;
				Dictionary_2_t1D10D55F8460717EBD55BA18B7F5C4342F991183* L_4 = V_0;
				int32_t L_5;
				L_5 = KeyValuePair_2_get_Key_mB0032D4553A685413694407A43E956D2BAC9F8EB_inline((&V_2), NULL);
				JointInfo_t884CFAB72D3EC119E136C37A9E3712FC372450A9 L_6;
				L_6 = KeyValuePair_2_get_Value_mECA8DCE5CACA2F5070353E0529214A2B7BFFCC14_inline((&V_2), NULL);
				NullCheck(L_4);
...
IL_002f_1:
			{
				bool L_7;
				L_7 = Enumerator_MoveNext_mFC5B28D2E9F275DF36274C90962D32AC85BC2536((&V_1), NULL);
				if (L_7)
				{
					goto IL_0013_1;
				}
...
IL_0048:
	...
	}
	{
		...
		L_10 = Dictionary_2_GetEnumerator_mDDC9ABDE22EE7CA33D63430594657C6828B499A9(L_9, NULL);
		V_1 = L_10;
	}
	{
		auto __finallyBlock = il2cpp::utils::Finally([&]
...
IL_0059_1:
			{
				...
				L_11 = Enumerator_get_Current_mD26596B306CFC7394F84A3A7A59E9F1D37B47DBE_inline((&V_1), NULL);
				V_3 = L_11;
				Dictionary_2_t1D10D55F8460717EBD55BA18B7F5C4342F991183* L_12 = V_0;
				int32_t L_13;
				L_13 = KeyValuePair_2_get_Key_mB0032D4553A685413694407A43E956D2BAC9F8EB_inline((&V_3), NULL);
				JointInfo_t884CFAB72D3EC119E136C37A9E3712FC372450A9 L_14;
				L_14 = KeyValuePair_2_get_Value_mECA8DCE5CACA2F5070353E0529214A2B7BFFCC14_inline((&V_3), NULL);
				NullCheck(L_12);
...
IL_0075_1:
			{
				bool L_15;
				L_15 = Enumerator_MoveNext_mFC5B28D2E9F275DF36274C90962D32AC85BC2536((&V_1), NULL);
				if (L_15)
				{
					goto IL_0059_1;
				}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void OVRSkeletonMapping__cctor_m98181CB7DC844E3A111E8B3E1B6AEA16876A604D (const RuntimeMethod* method) 
{
	...
	//<source_info:<no-source>:1>
	{
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_2), 0, 0, NULL);
		NullCheck(L_1);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_4), 1, 0, NULL);
		NullCheck(L_3);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_6), 2, 1, NULL);
		NullCheck(L_5);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_8), 3, 2, NULL);
		NullCheck(L_7);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_10), 4, 3, NULL);
		NullCheck(L_9);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_12), 5, 4, NULL);
		NullCheck(L_11);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_14), 6, 5, NULL);
		NullCheck(L_13);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_16), 7, 6, NULL);
		NullCheck(L_15);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_18), 8, 5, NULL);
		NullCheck(L_17);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_20), ((int32_t)9), 8, NULL);
		NullCheck(L_19);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_22), ((int32_t)10), ((int32_t)9), NULL);
		NullCheck(L_21);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_24), ((int32_t)11), ((int32_t)10), NULL);
		NullCheck(L_23);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_26), ((int32_t)12), ((int32_t)11), NULL);
		NullCheck(L_25);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_28), ((int32_t)13), 5, NULL);
		NullCheck(L_27);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_30), ((int32_t)14), ((int32_t)13), NULL);
		NullCheck(L_29);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_32), ((int32_t)15), ((int32_t)14), NULL);
		NullCheck(L_31);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_34), ((int32_t)16), ((int32_t)15), NULL);
		NullCheck(L_33);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_36), ((int32_t)17), ((int32_t)16), NULL);
		NullCheck(L_35);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_38), ((int32_t)18), ((int32_t)19), NULL);
		NullCheck(L_37);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_40), ((int32_t)19), ((int32_t)11), NULL);
		NullCheck(L_39);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_42), ((int32_t)20), ((int32_t)19), NULL);
		NullCheck(L_41);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_44), ((int32_t)21), ((int32_t)20), NULL);
		NullCheck(L_43);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_46), ((int32_t)22), ((int32_t)21), NULL);
		NullCheck(L_45);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_48), ((int32_t)23), ((int32_t)22), NULL);
		NullCheck(L_47);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_50), ((int32_t)24), ((int32_t)19), NULL);
		NullCheck(L_49);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_52), ((int32_t)25), ((int32_t)24), NULL);
		NullCheck(L_51);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_54), ((int32_t)26), ((int32_t)25), NULL);
		NullCheck(L_53);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_56), ((int32_t)27), ((int32_t)26), NULL);
		NullCheck(L_55);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_58), ((int32_t)28), ((int32_t)27), NULL);
		NullCheck(L_57);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_60), ((int32_t)29), ((int32_t)19), NULL);
		NullCheck(L_59);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_62), ((int32_t)30), ((int32_t)29), NULL);
		NullCheck(L_61);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_64), ((int32_t)31), ((int32_t)30), NULL);
		NullCheck(L_63);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_66), ((int32_t)32), ((int32_t)31), NULL);
		NullCheck(L_65);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_68), ((int32_t)33), ((int32_t)32), NULL);
		NullCheck(L_67);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_70), ((int32_t)34), ((int32_t)19), NULL);
		NullCheck(L_69);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_72), ((int32_t)35), ((int32_t)34), NULL);
		NullCheck(L_71);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_74), ((int32_t)36), ((int32_t)35), NULL);
		NullCheck(L_73);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_76), ((int32_t)37), ((int32_t)36), NULL);
		NullCheck(L_75);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_78), ((int32_t)38), ((int32_t)37), NULL);
		NullCheck(L_77);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_80), ((int32_t)39), ((int32_t)19), NULL);
		NullCheck(L_79);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_82), ((int32_t)40), ((int32_t)39), NULL);
		NullCheck(L_81);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_84), ((int32_t)41), ((int32_t)40), NULL);
		NullCheck(L_83);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_86), ((int32_t)42), ((int32_t)41), NULL);
		NullCheck(L_85);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_88), ((int32_t)43), ((int32_t)42), NULL);
		NullCheck(L_87);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_90), ((int32_t)44), ((int32_t)45), NULL);
		NullCheck(L_89);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_92), ((int32_t)45), ((int32_t)16), NULL);
		NullCheck(L_91);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_94), ((int32_t)46), ((int32_t)45), NULL);
		NullCheck(L_93);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_96), ((int32_t)47), ((int32_t)46), NULL);
		NullCheck(L_95);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_98), ((int32_t)48), ((int32_t)47), NULL);
		NullCheck(L_97);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_100), ((int32_t)49), ((int32_t)48), NULL);
		NullCheck(L_99);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_102), ((int32_t)50), ((int32_t)45), NULL);
		NullCheck(L_101);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_104), ((int32_t)51), ((int32_t)50), NULL);
		NullCheck(L_103);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_106), ((int32_t)52), ((int32_t)51), NULL);
		NullCheck(L_105);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_108), ((int32_t)53), ((int32_t)52), NULL);
		NullCheck(L_107);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_110), ((int32_t)54), ((int32_t)53), NULL);
		NullCheck(L_109);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_112), ((int32_t)55), ((int32_t)45), NULL);
		NullCheck(L_111);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_114), ((int32_t)56), ((int32_t)55), NULL);
		NullCheck(L_113);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_116), ((int32_t)57), ((int32_t)56), NULL);
		NullCheck(L_115);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_118), ((int32_t)58), ((int32_t)57), NULL);
		NullCheck(L_117);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_120), ((int32_t)59), ((int32_t)58), NULL);
		NullCheck(L_119);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_122), ((int32_t)60), ((int32_t)45), NULL);
		NullCheck(L_121);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_124), ((int32_t)61), ((int32_t)60), NULL);
		NullCheck(L_123);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_126), ((int32_t)62), ((int32_t)61), NULL);
		NullCheck(L_125);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_128), ((int32_t)63), ((int32_t)62), NULL);
		NullCheck(L_127);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_130), ((int32_t)64), ((int32_t)63), NULL);
		NullCheck(L_129);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_132), ((int32_t)65), ((int32_t)45), NULL);
		NullCheck(L_131);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_134), ((int32_t)66), ((int32_t)65), NULL);
		NullCheck(L_133);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_136), ((int32_t)67), ((int32_t)66), NULL);
		NullCheck(L_135);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_138), ((int32_t)68), ((int32_t)67), NULL);
		NullCheck(L_137);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_140), ((int32_t)69), ((int32_t)68), NULL);
		NullCheck(L_139);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_143), ((int32_t)70), 1, NULL);
		NullCheck(L_142);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_145), ((int32_t)71), ((int32_t)70), NULL);
		NullCheck(L_144);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_147), ((int32_t)72), ((int32_t)71), NULL);
		NullCheck(L_146);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_149), ((int32_t)73), ((int32_t)72), NULL);
		NullCheck(L_148);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_151), ((int32_t)74), ((int32_t)73), NULL);
		NullCheck(L_150);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_153), ((int32_t)75), ((int32_t)74), NULL);
		NullCheck(L_152);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_155), ((int32_t)76), ((int32_t)75), NULL);
		NullCheck(L_154);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_157), ((int32_t)77), 1, NULL);
		NullCheck(L_156);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_159), ((int32_t)78), ((int32_t)77), NULL);
		NullCheck(L_158);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_161), ((int32_t)79), ((int32_t)78), NULL);
		NullCheck(L_160);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_163), ((int32_t)80), ((int32_t)79), NULL);
		NullCheck(L_162);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_165), ((int32_t)81), ((int32_t)80), NULL);
		NullCheck(L_164);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_167), ((int32_t)82), ((int32_t)81), NULL);
		NullCheck(L_166);
		...
		JointInfo__ctor_m8B379538EC5C4ACB6D762D30C7F3B34FB6E7670B((&L_169), ((int32_t)83), ((int32_t)82), NULL);
		NullCheck(L_168);
